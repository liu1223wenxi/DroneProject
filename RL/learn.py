...
from DroneProject.utils.Logger import Logger
...
# from DroneProject.envs.MultiHoverAviary import MultiHoverAviary
from DroneProject.utils.utils import sync, str2bool
from DroneProject.utils.enums import ObservationType, ActionType
...
def run(multiagent=DEFAULT_MA, output_folder=DEFAULT_OUTPUT_FOLDER, gui=DEFAULT_GUI, plot=True, colab=DEFAULT_COLAB, record_video=DEFAULT_RECORD_VIDEO, local=True):
    ...
    # target_reward = 467. if not multiagent else 920.
    target_reward = 600. if not multiagent else 920.    #Waypoint
