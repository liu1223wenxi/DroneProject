...
class DroneBaseRLAviary(DroneBaseAviary):
    ...
    def __init__(self,
        ...
        if act in [ActionType.PID, ActionType.VEL]:
            ...
            """This line sets an environment variable KMP_DUPLICATE_LIB_OK to 'True'. 
            This is typically used to avoid errors related to loading multiple copies of the Intel MKL (Math Kernel Library) in environments where this can cause issues, 
            such as when using certain Python libraries like NumPy or TensorFlow with threading.""" 
