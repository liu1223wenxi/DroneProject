...
from DroneProject.utils.enums import DroneModel, Physics, ImageType
...
class DroneBaseAviary(gym.Env):
    ...
    def _housekeeping(self):
        ...
        self.DRONE_IDS = np.array([p.loadURDF(pkg_resources.resource_filename('DroneProject', 'assets/'+self.URDF),
                                              self.INIT_XYZS[i,:],
    ...
    def _parseURDFParameters(self):
        ...
        """
        URDF_TREE = etxml.parse(pkg_resources.resource_filename('DroneProject', 'assets/'+self.URDF)).getroot()
